...
namespace Scheduler
{
    public partial class Sun : UserControl
    {
        ...
        public Sun()
        {
            InitializeComponent();
            //open file
            fileOC(dataGridView7, 0);
        }

        private void editSun_Click(object sender, EventArgs e)
        {
            if (!dataGridView7.Enabled)
            {
                dataGridView7.Enabled = true;
                editSun.Image = Scheduler.Properties.Resources.icons8_edit_32_blue;
            }
            else
            {
                dataGridView7.Enabled = false;
                editSun.Image = Scheduler.Properties.Resources.icons8_edit_32;
            }
        }

        private void refreshSun_Click(object sender, EventArgs e)
        {
            fileOC(dataGridView7, 0);
            editSun.Image = Scheduler.Properties.Resources.icons8_edit_32;
            dataGridView7.Enabled = false;
        ...
        private void saveSun_Click(object sender, EventArgs e)
        {
            fileOC(dataGridView7, 1);
            refreshSun.PerformClick();
        }
